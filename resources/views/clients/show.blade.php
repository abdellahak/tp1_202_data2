  ...
  <div class="mx-auto w-full bg-slate-900 dark:bg-gray-100">
    <div class="flex justify-between items-center mb-4 p-4 dark:bg-white bg-slate-800 w-full">
      <div class="flex flex-col gap-2 md:flex-row w-full">
        ...
        <h1 class="text-2xl font-bold ">Détails de client N° {{ $client->id }}</h1>
      </div>
    ...
    <div class="max-w-2xl mx-auto p-6 dark:bg-white bg-slate-800 shadow-md rounded-lg mt-10">
      <h1 class="text-2xl font-bold dark:text-slate-800 text-slate-200 mb-4">Détails de le client N°
        {{ $client->id }}</h1>
      <table class="min-w-full dark:bg-white bg-slate-800 dark:text-gray-700 text-gray-300">
        ...
        <tbody>
          <tr class="w-full border-b dark:border-gray-700">
            <td class="py-2 px-4 font-semibold ">Prenom :</td>
          ...
          <tr class="w-full border-b dark:border-gray-700">
            <td class="py-2 px-4 font-semibold ">Telephone :</td>
            <td class="py-2 px-4 ">{{ $client->telephone }}</td>
          </tr>
          <tr class="w-full border-b dark:border-gray-700">
            <td class="py-2 px-4 font-semibold ">Ville :</td>
            <td class="py-2 px-4 ">{{ $client->ville }}</td>
          </tr>
          <tr class="w-full border-b dark:border-gray-700">
            <td class="py-2 px-4 font-semibold ">Date de naissance :</td>
            <td class="py-2 px-4 ">{{ $client->date_naissance }}</td>
          </tr>
        </tbody>
      </table>
      ...
      <div class="w-full flex justify-end flex-wrap gap-2 py-4 font-bold">
        ...
        <button
          ...
          data-id="{{ $client->id }}" title="Supprimer">Supprimer</button>
      </div>
    </div>
