...
<body class="bg-slate-900 text-white dark:bg-white dark:text-black">
    <div class="flex">
        <div class="container hidden md:block w-1/6 min-w-56 bg-slate-800 text-white dark:bg-gray-200 dark:text-black">
            ...
            <ul>
                <li class="my-1">
                    <a href="{{route('clients.index')}}" class="w-full bg-slate-700 dark:bg-gray-300 block p-3 text-md border-r-4 border-r-solid border-r-blue-600"><i class="fa-regular fa-user mx-2"></i>Clients</a>
                </li>
                <li class="my-1">
        ...
        <div class="container mx-auto p-4 bg-slate-900 dark:bg-white">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex flex-col gap-2 md:flex-row">
                    <a href="{{route('clients.create')}}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 block">Ajouter Client</a>
            ...
            <p class="mb-4 bg-slate-600 dark:bg-gray-300 w-fit p-1 rounded-md">Le nombre des clients est : <span class="font-semibold">{{count($clients)}}</span></p>
                ...
                <table class="min-w-full shadow-md overflow-hidden">
                    <thead class="bg-slate-800 text-white dark:bg-gray-200 dark:text-black rounded-lg">
                        <tr>
                            ...
                            <th class="py-2 px-4">Ddate Naissance</th>
