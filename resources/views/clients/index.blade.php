...
@section('title', 'lite des clients')
@section('aside')
  <li class="my-1">
    ...
    <div class="flex justify-between items-center mb-4 p-4 dark:bg-white bg-gray-800 w-full">
      ...
      <div class="flex flex-col gap-2 md:flex-row">
        <a href="{{ route('clients.create') }}"
          class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 block">Ajouter
          Client</a>
          ...
          @foreach ($clients as $item)
            <tr class="hover:bg-slate-700 dark:hover:bg-gray-300" id="item-{{ $item->id }}">
              ...
              <td class="py-2 px-4 text-center">
                <a href="{{ route('clients.show', $item->id) }}" class="text-blue-500 hover:underline" title="Details">
